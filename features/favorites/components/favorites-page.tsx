...
export function FavoritesPage() {
    ...
    return (
        <div className="min-h-screen bg-background">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <motion.div
                        ...
                        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                            <TabsList className="grid w-full grid-cols-2 rounded-full p-1 bg-muted/80">
                                <TabsTrigger value="favorites" className="gap-2 rounded-full">
            ...
            {/* Filter & Content Section - only when Favorites tab active */}
            {activeTab === "favorites" && (
                                    ...
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                                                ...
                                                <AlertDialogDescription>
                                                    Tindakan ini akan menghapus semua {totalFavorites} resep dari
                                                    koleksi favorit Anda. Tindakan ini tidak dapat dibatalkan.
                                                </AlertDialogDescription>
                                            </AlertDialogHeader>
                                            <AlertDialogFooter>
